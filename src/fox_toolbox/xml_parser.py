...
def get_correl(xmlfile):
	correl_node = xmlfile.find('.//TermFCorrs0/OneDCurve')
	#_, interp, buckets, values = parse_1d_curve(correl_node.find('OneDCurve'))
	correl = get_float_node(correl_node, 'Values')
	return correl
